...
#' }
#'
#' @import tidyverse ggplot2 lubridate dplyr ggimage cowplot extrafont tidyr ggchicklet grid # nolint: line_length_linter.
...
#'
#' @export
create_nhl_week_visualization <- function(
    week_number, schedule_path = "/path/to/nhl_schedule.RDS",
  ...
  if (!is.null(week_number)) {
    ...
    stop("Please provide a valid week number.")
  }
}
