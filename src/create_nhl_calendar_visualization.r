...
#' \itemize{
#'   \item Loads NHL schedule and team color data from RDS files
#'   \item Processes the game data for the specified team, year, and month
#'   \item Creates a ggplot2 calendar visualization
#'   \item Adds team logos and game information to the calendar
#'   \item Generates a legend for home and away games
#'   \item Combines the calendar and legend into a final image
#'   \item Saves the resulting calendar as a PNG file
#' }
#'
#' @note This function requires several R packages including tidyverse, ggplot2, lubridate, and others.
#' It also relies on pre-saved RDS files containing NHL schedule and team information.
#'
#' @examples
#' \dontrun{
#' # Generate a calendar for the Toronto Maple Leafs for January 2024
#' create_nhl_calendar_visualization(
#'   "TOR",
#'   2024,
#'   1,
...
#'
#' @export
create_nhl_calendar_visualization <- funtion(
  team_abbr, ano, mes, schedule_path = "/path/to/nhl_schedule.RDS",
  ...
  criar_calendario_jogos <- function(
    ...
    # Save our inset plot
    ggsave("/Users/danilooak/Documents/Code/R Projects/Sports Analytics/NHL/imgs/Figures/p_legend.png",
           p_legend,
  ...
  if (!is.null(ano) && !is.null(mes)) {
    ...
    ggsave("/Users/danilooak/Documents/Code/R Projects/Sports Analytics/NHL/imgs/Figures/calendario_mensal.png",
          plot_schedule,
    ...
    # Read in Inset plot
    inset <- image_read("/Users/danilooak/Documents/Code/R Projects/Sports Analytics/NHL/imgs/Figures/p_legend.png")
    
    # Read in Comet plot
    graf <- image_read("/Users/danilooak/Documents/Code/R Projects/Sports Analytics/NHL/imgs/Figures/calendario_mensal.png")
    
    # Juntar imagens
    image_composite(graf, inset, offset = "+440+50") %>%
      image_write(paste0(
        "/Users/danilooak/Documents/Code/R Projects/Sports Analytics/NHL/imgs/Figures/calendario_mensal_",
        team_abbrev,
        "_", ano, "_", mes, ".png")
      )
  }
